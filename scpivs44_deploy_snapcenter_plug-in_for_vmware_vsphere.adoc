...
* Per proteggere le macchine virtuali su datastore vVol, è necessario prima implementare gli strumenti ONTAP per VMware vSphere. I tool ONTAP predisposizioni e configurano lo storage su ONTAP e sul client web VMware.
