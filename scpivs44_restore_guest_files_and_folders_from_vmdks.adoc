...
. Nel client Web VMware vSphere, fare clic su *Ripristino file guest* dall'elenco a discesa secondario per avviare la procedura guidata.
...
+
Questa opzione utilizza le impostazioni e-mail configurate durante la configurazione del client Web VMware vSphere in vCenter.
