...
. Dal menu MySQL Backup and Restore Configuration (Configurazione backup e ripristino MySQL), inserire l'opzione *3) Restore MySQL backup* (Ripristina backup MySQL).
